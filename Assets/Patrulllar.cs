...
public class Patrulllar : StateMachineBehaviour
{
    ...
    {
        if(controller._agen.hasPath && controller._agen.remainingDistance < 0.1f)
        { 
            posicionActual++;
        ...
        controller._agen.SetDestination(controller._puntoPatrullaje[posicionActual].position);
    }
